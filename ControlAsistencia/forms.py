...
class EmpleadoForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ['codigo', 'nombre', 'cedula', 'fecha_registro', 'centro_de_costos', 'cargo']


class EmpleadoCodigoForm(forms.Form):
    codigo = forms.CharField(max_length=100, label='Código del Empleado')